/*
=============================================================================
	File:	Example_HelloCube.h
	Desc:	Shows usage of the engine.
=============================================================================
*/

class Sample_HelloCube : public Sample_Basic 
{
public:
	Sample_HelloCube()
	{}

	override(Sample_Basic) const mxChar* GetName() const { return TEXT("Hello, Cube!"); }
