...
=============================================================================
	File:	UserInput.h
	Desc:	Definitions for user input event handling.
=============================================================================
*/

#ifndef __MX_USER_INPUT_H__
#define __MX_USER_INPUT_H__
...
public:
	...
	mxChar		CharCode;	// Character corresponding to the key (0, if not a character).
};

//
//	mxConsoleEvent
//
class mxConsoleEvent {
public:
	mxChar *	Text;
...
enum EInputEvent
{
	...
	InputEvent_GUI,	// these can be generated in response to keyboard and/or mouse events

	InputEvent_Console,	// text was typed at some console

	InputEvent_User,	// custom, user-defined input event
};
...
public:
	...
	union
	{
		mxKeyboardEvent	Keyboard;
		mxMouseEvent	Mouse;
		mxConsoleEvent	Console;
	};
};
...
public:
	...
	// Returns 'true' if the event has been processed and should not be handled anymore.
	virtual bool	ProcessInput( const mxInputEvent& rEvent ) = 0;
};

}//End of namespace abc

#endif // ! __MX_USER_INPUT_H__
